    ...
    static let russian = FactoryPresetContent(
        ...
        entries: [
            ...
            .briefTranslated: .init(name: "Кратко, с переводом", template: """
                Изложи следующий текст в двух-трёх предложениях. Пиши на {language}, на каком бы языке ни \
                был исходный текст.
                {instruction}
            ...
            .bulletsTranslated: .init(name: "Списком, с переводом", template: """
                ...
                начинается с «- ». Пиши на {language}, на каком бы языке ни был исходный текст.
                {instruction}

                {text}
                """),
            .tldrTranslated: .init(name: "TL;DR, с переводом", template: """
                Дай TL;DR следующего текста одним предложением, на {language}, на каком бы языке ни был \
                исходный текст.
                {instruction}
            ...
            .keyActionsTranslated: .init(name: "Действия, с переводом", template: """
                Выпиши конкретные задачи из следующего текста нумерованным списком, на {language}, на каком \
